...
process.TFileService = cms.Service("TFileService",
                                   ...
                                   fileName = cms.string("NoExt_ZMM_140PU.root"),
...
process.ak4PFGenJEC = cms.EDAnalyzer('METPerformance',
                                     L1JECTag = cms.string("SLHC26_HGCalNoExt_140PU_L1FastJet_AK4PF.txt"),
                                     L2JECTag = cms.string("SLHC26_HGCalNoExt_140PU_L2Relative_AK4PF.txt"),
                                     L3JECTag = cms.string("SLHC26_HGCalNoExt_140PU_L3Absolute_AK4PF.txt"),
                                     MuonInputTag = cms.InputTag("ZMMProducer", "ZMMTightMuon"),
                                     JetEtaThresTag = cms.untracked.double(JetEta),
                                     PFJetInputTag = cms.InputTag("ak4PFJets"),
                                     srcRhoTag      = cms.InputTag('kt6PFJets','rho'),
...
process.ak4_10_PFCHSJEC = cms.EDAnalyzer('METPerformance',
                                         L1JECTag = cms.string("SLHC26_HGCalNoExt_140PU_L1FastJet_AK4PFchs.txt"),
                                         L2JECTag = cms.string("SLHC26_HGCalNoExt_140PU_L2Relative_AK4PFchs.txt"),
                                         L3JECTag = cms.string("SLHC26_HGCalNoExt_140PU_L3Absolute_AK4PFchs.txt"),
                                         MuonInputTag = cms.InputTag("ZMMProducer", "ZMMTightMuon"),
                                         JetJECThresTag = cms.untracked.double(10),
                                         PFJetInputTag = cms.InputTag("ak4PFJetsCHS"),
                                         srcRhoTag      = cms.InputTag('kt6PFJets','rho'),
...
process.ak4PuppiJEC = cms.EDAnalyzer('METPerformance',
                                     L1JECTag       = cms.string("SLHC26_HGCalNoExt_140PU_L1FastJet_AK4PUPPI.txt"),
                                     L2JECTag       = cms.string("SLHC26_HGCalNoExt_140PU_L2Relative_AK4PUPPI.txt"),
                                     L3JECTag       = cms.string("SLHC26_HGCalNoExt_140PU_L3Absolute_AK4PUPPI.txt"),
                                     MuonInputTag   = cms.InputTag("ZMMProducer", "ZMMTightMuon"),
                                     PFJetInputTag  = cms.InputTag("ak4PuppiJets"),
                                     srcRhoTag      = cms.InputTag(''),
                                     JetEtaThresTag = cms.untracked.double(JetEta),
