...
process.source = cms.Source("PoolSource",
                            #fileNames = cms.untracked.vstring('file:/eos/uscms/store/user/lpchgcal/benwu/TP_SLHC23/DYMM_SHCal_140PU_aged/DYMM_SHCAL_140PU_aged_106_1_HpL.root')
...
process.TFileService = cms.Service("TFileService",
      ...
      #fileName = cms.string("Phase2_ZMM_140PU.root"),
